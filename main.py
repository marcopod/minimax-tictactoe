...
class Board:
    def __init__(self):
        ...
        self.emtpty_sqrs = self.squares  # [squares]
        self.marked_sqrs = 0
        print(self.squares)
    ...
    def final_state(self, show=False):
        ...
        for col in range(COLS):
            if self.squares[0][col] == self.squares[1][col] == self.squares[2][col] != 0:
                if show:
                    ...
                    init_pos = (col * SQSIZE + SQSIZE // 2, 20)
                    final_pos = (col * SQSIZE + SQSIZE // 2, HEIGHT - 20)
                    pygame.draw.line(screen, color, init_pos, final_pos, LINE_WIDTH)
        ...
        for row in range(ROWS):
            if self.squares[row][0] == self.squares[row][1] == self.squares[row][2] != 0:
                if show:
                    ...
                    init_pos = (20, row * SQSIZE + SQSIZE // 2)
        ...
        if self.squares[0][0] == self.squares[1][1] == self.squares[2][2] != 0:
            if show:
                ...
                pygame.draw.line(screen, color, init_pos, final_pos, CROSS_WIDTH)
...
class Game:
    ...
    # Show the lines separating the tile squares
    def show_lines(self):
    ...
    def draw_fig(self, row, col):
        ...
        if self.player == 1:
            ...
            pygame.draw.line(
                screen, CROSS_COLOR, start_ascending, end_ascending, CROSS_WIDTH
            )
            ...
            pygame.draw.line(
                screen, CROSS_COLOR, start_descending, end_descending, CROSS_WIDTH
            )
        # draw circle
        elif self.player == 2:
    ...
    # Next turn
    # Returns: 1 or 2
    # If the player is 0, it returns 1
    # If the player is 1, it returns 2
    # 1 is the human player, 2 is the bot
    def next_turn(self):
